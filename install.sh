...
sudo pacman -Syu --needed --noconfirm base-devel git pkgconf gtk4 gtk4-layer-shell rust labwc meson ninja playerctl grim wl-clipboard libnotify gammastep wlsunset wireplumber pipewire-pulse pipewire-alsa ddcutil zip unzip pacman-contrib networkmanager networkmanager-openvpn networkmanager-vpnc networkmanager-pptp networkmanager-l2tp networkmanager-openconnect networkmanager-strongswan wireguard-tools openvpn bluez bluez-utils
