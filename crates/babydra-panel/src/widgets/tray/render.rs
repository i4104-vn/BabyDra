...
pub fn build_tray_button(icon_name: &str, title: &str) -> gtk4::Button {
    ...
    let icon = babydra_utils::ui::icon::get_system_or_file_icon(icon_name, "image-missing");
...
pub fn show_context_menu(btn: &gtk4::Button, service: &str, items: &[babydra_common::tray::MenuItem]) {
...
fn build_gio_menu(items: &[babydra_common::tray::MenuItem], action_group: &gtk4::gio::SimpleActionGroup, service: &str) -> gtk4::gio::Menu {
    ...
    for item in items {
        ...
        action.connect_activate(move |_, _| {
            babydra_common::tray::activate_menu_item(&s_name, item_id);
        });
