...
pub mod prelude {
    pub use crate::components::{
        build_tray_gio_menu, clear_box, clear_list_box, close_tray_menu, create_accent_button,
        create_battery_icon, create_button, create_card, create_color_btn, create_colored_icon,
        create_css_card, create_danger_btn, create_danger_item, create_fab, create_footer_box,
        ...
        create_wp_thumb, create_loading_card, create_loading_icon, create_loading_placeholder_row,
        render_wifi_svg, show_tray_menu, update_toggle_state,
