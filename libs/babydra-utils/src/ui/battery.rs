...
pub fn draw_cairo_battery(cr: &gtk4::cairo::Context, width: f64, height: f64, percentage: u32, is_charging: bool, is_dark: bool) {
    ...
    draw_rr(shell_x + pad, shell_y + pad, fill_w, fill_h, (corner_r - 1.0).max(1.0));
...
pub fn create_battery_drawing_area(percentage: u32, is_charging: bool, width: i32, height: i32) -> DrawingArea {
