...
impl DirectoryModel {
    ...
    pub fn sort(&mut self, folders_first: bool) {
        self.entries.sort_by(|a, b| {
            if folders_first {
                let a_is_dir = matches!(a.file_type, crate::models::explore::file_entry::FileType::Directory);
                let b_is_dir = matches!(b.file_type, crate::models::explore::file_entry::FileType::Directory);
