...
use super::state::{BRIGHTNESS_STATE, DdcutilProxyBlocking};
...
fn get_active_session_path(manager: &LogindManagerProxyBlocking<'_>) -> Option<zbus::zvariant::OwnedObjectPath> {
...
fn set_backlight_brightness_logind(device: &str, val: f64) -> Result<(), Box<dyn std::error::Error>> {
