...
pub fn build_footer_layout() -> (
    ...
    let shutdown_icon = babydra_common::icon::get_icon_colored("power", 18, "#ff5555");
    ...
    let reboot_icon = babydra_common::icon::get_icon_colored("restart", 18, "#ffb86c");
    ...
    let suspend_icon = babydra_common::icon::get_icon_colored("sleep", 18, "#89b4fa");
    ...
    let logout_icon = babydra_common::icon::get_icon_colored("logout", 18, "#cba6f7");
