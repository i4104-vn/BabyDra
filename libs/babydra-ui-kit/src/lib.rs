...
pub mod prelude {
    pub use crate::components::{
        attach_hover_popover, build_hover_card, clear_box, clear_list_box,
        create_accent_button, create_battery_icon, create_button, create_card,
        create_css_card, create_color_btn, create_colored_icon, create_fab,
        create_icon_badge, create_icon_button, create_icon_btn, create_list_row,
        create_placeholder, create_popover, create_popover_box,
        create_scroll_list, create_sidebar_btn, create_sidebar_wbtn,
        create_square_tile, create_subtitle, create_switch, create_switch_card,
        create_sys_wifi_icon, create_title, create_toggle_tile, create_vpn_icon,
        create_wp_thumb, create_wifi_icon,
        create_wifi_net_icon, create_rssi_icon,
        render_wifi_svg, set_tooltip, update_toggle_state,
        build_tray_gio_menu, close_tray_menu, create_menu_for,
        create_menu_popover, create_footer_box, create_footer_btn,
        create_group_header, create_menu_item, create_danger_item,
        create_danger_btn, create_menu_full, create_menu_sens,
        create_menu_shortcut, create_menu_sep, create_menu_text,
        create_submenu_item, show_tray_menu, ContextMenuBuilder, CustomSlider,
    ...
    pub use crate::ui::{
        ...
        battery::{
            create_battery_area, draw_cairo_battery, get_battery_hex,
            get_battery_rgb,
        },
        icon::resolver::get_resolved_icon,
        icon::{
            get_icon, get_icon_colored, get_icon_from_svg, get_logo_png, get_fallback_icon,
            set_image_from_icon, set_fallback_icon,
        },
