...
icon_asset!(
    DARK_BRIGHTNESS_LOW_SVG,
    LIGHT_BRIGHTNESS_LOW_SVG,
    "brightness-low.svg"
);
icon_asset!(
    DARK_BRIGHTNESS_MEDIUM_SVG,
    LIGHT_BRIGHTNESS_MEDIUM_SVG,
...
icon_asset!(
    DARK_EXTERNAL_LINK_SVG,
    LIGHT_EXTERNAL_LINK_SVG,
    "external-link.svg"
);
...
icon_asset!(
    DARK_NIGHT_LIGHT_SVG,
    LIGHT_NIGHT_LIGHT_SVG,
    "night-light.svg"
);
icon_asset!(
    DARK_PERFORMANCE_SVG,
    LIGHT_PERFORMANCE_SVG,
    "performance.svg"
);
...
icon_asset!(
    DARK_VOLUME_MUTE_SVG,
    LIGHT_VOLUME_MUTE_SVG,
    "volume-mute.svg"
);
...
icon_asset!(
    DARK_FOLDER_DOWNLOAD_SVG,
    LIGHT_FOLDER_DOWNLOAD_SVG,
    "folder-download.svg"
);
icon_asset!(
    DARK_FOLDER_DOCUMENTS_SVG,
    LIGHT_FOLDER_DOCUMENTS_SVG,
    "folder-documents.svg"
);
icon_asset!(
    DARK_FOLDER_PICTURES_SVG,
    LIGHT_FOLDER_PICTURES_SVG,
    "folder-pictures.svg"
);
icon_asset!(
    DARK_FOLDER_MUSIC_SVG,
    LIGHT_FOLDER_MUSIC_SVG,
    "folder-music.svg"
);
icon_asset!(DARK_USER_TRASH_SVG, LIGHT_USER_TRASH_SVG, "user-trash.svg");
icon_asset!(
    DARK_FOLDER_DESKTOP_SVG,
    LIGHT_FOLDER_DESKTOP_SVG,
    "folder-desktop.svg"
);
icon_asset!(
    DARK_FOLDER_VIDEOS_SVG,
    LIGHT_FOLDER_VIDEOS_SVG,
    "folder-videos.svg"
);
icon_asset!(
    DARK_DRIVE_HARDDISK_SVG,
    LIGHT_DRIVE_HARDDISK_SVG,
    "drive-harddisk.svg"
);
