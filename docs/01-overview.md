...
Mã nguồn được phân rã thành các crate và thư viện độc lập. Các module giao tiếp với nhau qua D-Bus, Unix Domain Socket hoặc cơ chế gọi hàm nội bộ qua thư viện dùng chung (`babydra-core`).
