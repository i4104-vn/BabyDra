//! Event wiring and async operations for Device & Account settings.

use super::render::DeviceAccountWidgets;
...
pub fn wire_events(widgets: &DeviceAccountWidgets) {
