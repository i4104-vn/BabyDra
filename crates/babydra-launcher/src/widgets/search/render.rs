...
pub fn build_search_button(query: &str) -> (gtk4::Button, gtk4::Label) {
    ...
    let web_icon = babydra_ui_kit::ui::icon::get_fallback_icon("web-browser", "text-html");
    ...
    let badge_label = gtk4::Label::new(Some(&babydra_core::i18n::trans("launcher.web")));
    ...
    // Description row
    let desc_label = gtk4::Label::new(Some(&babydra_core::i18n::trans("launcher.web_desc")));
